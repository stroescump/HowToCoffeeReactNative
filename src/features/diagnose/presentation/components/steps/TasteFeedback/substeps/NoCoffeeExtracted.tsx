...
const NoCoffeeExtracted = ({ noCoffeeDetails }: NoCoffeeExtractedProps) => {
    const { showPopup } = usePopup();
    const { t } = useTranslation();
    const { image, tasteTitleRes, tasteDescriptionRes } = noCoffeeDetails
...
export default NoCoffeeExtracted